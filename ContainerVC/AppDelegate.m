...
- (NSURL *)applicationDocumentsDirectory {
    ...
    // This code uses a directory named "com.example.ContainerVC" in the
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"ContainerVC"
                                              withExtension:@"momd"];
    _managedObjectModel =
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory]
        URLByAppendingPathComponent:@"ContainerVC.sqlite"];
    NSError *error = nil;
